...
<body id="page-top">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body text-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="taxID" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="corpBussDesc" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <input type="text" class="form-control" id="rt" aria-describedby="emailHelp">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="offPhone" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="fas" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="firstRegNo" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="legalID1" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="legalID2" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="legalID3" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="legalID4" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="bdName" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <select class="form-select" aria-label="Default select example" id="sector">
                                                <option selected>- Silahkan Pilih -</option>
                                                <option value="25">Pemerintah Pusat</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <input type="text" class="form-control" id="accountOfficer" aria-describedby="emailHelp">
                                        </div>
                                    </div>
    ...
    <script>
        function submitNewCIF(element){
            ...
            console.log(document.getElementById("firstRegDateƒ").value);
