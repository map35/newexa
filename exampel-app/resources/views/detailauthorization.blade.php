                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <!-- ======PEMBUKAAN REKENING====== -->
                                    ...
                                    <p>Otorisasi Pembukaan Rekening Nasabah Baru - CIF Perusahaan</p>
                                <div class="card-body text-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <select class="form-select" aria-label="Default select example">
                                                ...
                                                <option value="2">U.A.E</option>
                                                <option value="3">Afghanistan</option>
                                                <option value="4">Antigua</option>
                                                <option value="5">Anguilla</option>
                                                <option value="6">Albania</option>
                                                <option value="7">Armenia</option>
                                                <option value="8">Neth Ant.</option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <label for="exampleInputEmail1" class="form-label">Status Kependudukan (*)</label>
                                        </div>
                                        <div class="col-lg-1">
                                            <label for="exampleInputEmail1" class="form-label">:</label>
                                        </div>
                                    ...
                                    <hr>
                                    <p class="text-pembukaan">Informasi Data Pekerjaan (Optional)</p>
                                     <p><br>
                                    <div class="row">
                                        <div class="col-lg-3">
                                    ...
                                    <hr>
                                    <p class="text-pembukaan">Informasi Fasilitas e-Channel</p>
                                     <p><br>
                                    <div class="row">
                                        <div class="col-lg-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <label for="exampleInputEmail1" class="form-label">Tanggal Permohonan</label>
                                        </div>
                                        <div class="col-lg-1">
                                            <label for="exampleInputEmail1" class="form-label">:</label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <label for="exampleInputEmail1" class="form-label">Tanggal Otorisasi</label>
                                        </div>
                                        <div class="col-lg-1">
                                            <label for="exampleInputEmail1" class="form-label">:</label>
                                        </div>
